...
const handleRegister = async () => {
  ...
  return (
    <div className="container2">
              <div className="moto">
          Get a headstart to your professional life
        </div>
      ...
      <div className="logo">
        ...
        <div className="google">
          <GoogleButton
            ...
            style={{width:"300px",fontSize:"18px",margin:"auto",borderRadius:"2px"}}
             onClick={ handleGoogleSignIn }
         />
        </div>
        <div className="sign">
          Already on LinkedIn? <span onClick={()=>{navigate("/login")}}>Sign In</span>
        </div>
      </div>
    </div>
  )
